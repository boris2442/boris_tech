  ...
  <section>
    ...
    <div
      ...
      <p class="mb-6 text-lg text-[var(--text-secondary)] dark:text-[var(--dark-grey)]">
        Chez <strong>Boris Tech</strong>, nous accordons une grande importance à la satisfaction de nos clients.
      ...
      <div class="mb-8">
        ...
        <ul class="list-disc list-inside mt-3 space-y-2">
          <li>Erreur de facturation imputable à Boris Tech.</li>
      ...
      <div class="pb-8">
        ...
        <p>
          ...
          <a href="mailto:boristech99@gmail.com"
            class="text-[var(--accent-cyan)] hover:underline dark:text-[var(--dark-gold)]">boristech99@gmail.com</a>.
        </p>
      </div>
