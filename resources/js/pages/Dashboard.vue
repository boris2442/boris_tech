                    ...
                    <div class="kpi-text">
                        ...
                        <p class="text-xs">
                            <i>
                                ...
                                <template v-else class="text-xs"> <span>Aucune commande</span> </template>
                            </i>
                        </p>
                    </div>
                </div>
            ...
            <div class="relative min-h-[100vh] flex-1 rounded-xl border border-sidebar-border/70 md:min-h-min dark:border-sidebar-border">
                ...
                <div class="rounded-xl bg-white p-6 shadow-lg dark:bg-[#090909]">
                    ...
                    <table class="w-full text-left text-sm">
                        ...
                        <tbody>
                            <tr v-for="order in orders" :key="order.id" class="border-b text-sm hover:bg-gray-100 dark:hover:bg-gray-700">
