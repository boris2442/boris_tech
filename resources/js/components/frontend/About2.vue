    ...
    <section id="about" class="bg-[var(--background-light)] py-12 md:py-20 dark:bg-[var(--dark-background)]">
        <div class="container mx-auto flex flex-col-reverse items-center gap-8 px-4 md:flex-row md:gap-16 max-w-6xl">
            ...
            <div class="w-full md:w-1/2 max-w-xl md:text-left">
                <h2
                    class="mb-4 text-2xl sm:text-3xl md:text-3xl font-bold text-[var(--primary-blue)] dark:text-[var(--dark-gold)]">
                    À propos de Boris Tech
                </h2>
                <p
                    ...
                    Chez <span class="font-semibold text-[var(--primary-blue)] dark:text-[var(--dark-gold)]">Boris
                        Tech</span>,
                ...
                <Link :href="about().url" prefetch aria-label="En savoir plus sur Boris Tech"
            ...
            <div class="w-full md:w-1/2 rounded-lg overflow-hidden flex justify-center md:justify-end">
                <img src="assets/about1.jpg" alt="Boris Tech - À propos"
