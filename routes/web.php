...
Route::get('/posts', [BlogFrontendController::class, 'index'])->name('blogFrontend.index');
...
Route::get('/posts/{slug}', [BlogFrontendController::class, 'show'])->name('blogrontend.show');
// Backend routes
// Categories create
...
// Frontend blog route
//Route::get('/blogs', [PostController::class, 'AfficheFrontend'])->name('blogAffiche.index');
